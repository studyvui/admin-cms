// ============================================================
// Sinh cau hoi that Toan Lop 5 tu GRADE5_BUILTIN_TEMPLATES (Phase 3, 2026-08-13).
...
//
// Chay: npx tsx scripts/gen-grade5-questions.ts > /path/to/phase3_g5_rows.json
// ============================================================
import { GRADE5_BUILTIN_TEMPLATES } from "../lib/math-gen/builtins-grade5";
...
function main() {
  ...
  for (let week = 1; week <= 35; week++) {
    ...
    const templates = GRADE5_BUILTIN_TEMPLATES.filter((t) => t.id.startsWith(`TPL_G5_W${wk}_`));
